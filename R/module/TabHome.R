...
tabHome <- tabPanel("Home", icon=icon("home", lib = "glyphicon"),
                      fluidRow(
                        ...
                        column(4,style = "background-color: skyblue;",
                               h3("User Guidence"),
                               HTML("To work out your own result, you can download the R markdown file, or use the <em>Draw</em>/<em>Example</em> panel depending on the senario."),
                               ...
                               HTML("You can directly add nodes and edges in the Draw panel to obtaion the result"),
                               tags$video(id="video1", type = "video/mp4",width="350", height="240",
                                          src = "Draw_Ex.mp4", controls = "controls"),
                               br(),br(),
                               h5("Key operation video (Example)"),
                               HTML("You can simply choose the specific procedure (e.g. <em>Bonferroni-Holm Test</em>) in the <em>Example</em> panel"),
